...
from flaskblog.forms import RegistrationForm, LoginForm, UpdateAccountForm, SurveyForm, PostForm
...
def save_picture(form_picture):
	...
	_, f_ext = os.path.splitext(form_picture.filename)  # _  -> dont need f_name
